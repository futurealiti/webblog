...
class Home_controller extends Home_Core_Controller
{
    ...
    public function index()
    {
        ...
        $data['popularposts'] = $this->post_model->get_popular_posts(4);
        $data['cricketposts'] = $this->post_model->get_our_picks(3);
        $data['footballposts'] = $this->post_model->get_posts_by_category(1);
        $data['healthfitnessposts'] = $this->post_model->get_posts_by_category(3);
        $data['artfashionsposts'] = $this->post_model->get_posts_by_category(5);
        $data['recentposts'] = $this->post_model->get_recent_posts(8);
        $data['todayposts'] = $this->post_model->get_today_posts(6);
        // echo '<pre>';
        // print_r($data);
        // echo '</pre>';
        // die();
        ...
        // $this->load->view('partials/_orgheader', $data);
        // $this->load->view('org_index', $data);
        // $this->load->view('partials/_orgfooter');
    }
