...
class Language_model extends CI_Model
{
    ...
    public function add_language_settings($lang_id)
    {
        ...
        $settings = array(
            'lang_id' => $lang_id,
            'application_name' => "Futurealiti",
            'site_title' => "Futurealiti - Blog Magazine",
            'home_title' => "Index",
            'site_description' => "Futurealiti - Blog Magazine",
            'keywords' => "Futurealiti, Blog, Magazine",
            'primary_font' => 19,
            'secondary_font' => 25,
            'facebook_url' => "",
            'twitter_url' => "",
            ...
            'copyright' => "Copyright 2021 Futurealiti - All Rights Reserved.",
        );
    ...
    public function add_language_pages($lang_id)
    {
        //add pages
        $page = array(
            'lang_id' => $lang_id, 'title' => "Gallery", 'slug' => "gallery", 'page_description' => "Futurealiti Gallery Page", 'page_keywords' => "infinite, gallery , page", 'is_custom' => 0, 'page_content' => "", 'page_order' => 2, 'page_active' => 1, 'title_active' => 1, 'breadcrumb_active' => 1, 'right_column_active' => 0, 'need_auth' => 0, 'location' => "header", 'parent_id' => 0
        );
